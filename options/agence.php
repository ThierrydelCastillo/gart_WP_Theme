...
class AgenceMenuPage
{
    ...
    public static function registerScripts($suffix)
    {
        if ($suffix === 'settings_page_agence_options') {
            wp_register_style('flatpickr', 'https://cdn.jsdelivr.net/npm/flatpickr/dist/flatpickr.min.css', [], false, false);
    ...
    public static function registerSettings()
    {
        ...
        add_settings_section('agence_options_section', 'Paramètres', function () {
            echo "Vous pouvez içi gérer les paramètres liés à l'agence immobilière";
        }, self::GROUP);
